...
const LayoutWrapper = ({ children }) => {
  ...
  useEffect(() => {
    // âœ… upload local data first, then fetch from firebase
        ...
        <div className="bx-grid-wrapper">
          <div
            className={`
                ...
                ${activeItemId ? "4 w-[240px] sm:w-[240px] md:w-[240px] lg:w-[240px] xl:w-[60px] 2xl:w-[60px] bx-menu-multinav " : 
                  " 2xl:w-[240px] xl:w-[240px] sm:w-[60px] md:w-[60px] lg:w-[60px] w-[0px] bx-menu-multinav-1 6"}
              `}
